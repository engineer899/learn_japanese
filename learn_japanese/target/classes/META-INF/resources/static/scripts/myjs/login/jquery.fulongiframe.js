 ...
 */
 ;(function($){
	...
	function init_parent_iframeHeight(){
		...
		$("body").append('<iframe id="fulongiframe" style="display:none" src="localhost:8080/zhirong.cas/pages/system/agent.html#'+dHeight+'" scrolling="no" height="0px" width="0px"></iframe>');
	}
	$(function(){
		init_parent_iframeHeight();
	})

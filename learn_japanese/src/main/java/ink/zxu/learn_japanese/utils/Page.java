...
import ink.zxu.learn_japanese.utils.Const;
import ink.zxu.learn_japanese.utils.PageData;
import ink.zxu.learn_japanese.utils.Tools;
	...
	public String getPageStr() {
		...
		if(totalResult>0){
			...
			if(currentPage==1){
				...
				sb.append("	<li style=\"cursor:pointer;\"><a onclick=\"toTZ();\" style=\"background: #7DCD2E\" class=\"btn btn-mini btn-success\">跳转</a></li>\n");
			...
			for(int i=startTag; i<=totalPage && i<=endTag; i++){
				if(currentPage==i)
					sb.append("<li><a style='background-color: #7DCD2E;'><font color='#fff'>"+i+"</font></a></li>\n");
				else
			...
			sb.append("var reg = /^[1-9]\\d*/;");
			sb.append("if(!reg.test(toPaggeVlue)){");
			sb.append("layer.tips('页码只能为正整数','#toGoPage',{tips:[3, '#78BA32']});");

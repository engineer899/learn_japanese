function deleteAnn(id){
    layer.confirm('是否删除？', {icon: 3, title:'提示'}, function(index){
        //执行删除
        $.ajax({
            url : contextPath + '/manage/manageAnnController/deleteAnn',
            timeout : 300000,
            dataType : "json",
            type : "post",
            data : {
...
function addAnn(){
    layer.open({
        ...
        area: ['100%', '100%'],  //大小
        content: contextPath + '/manage/manageAnnController/Ann_add'
    });
}
...
function queryAnnDetails(id){
    layer.open({
        ...
        maxmin: false,		//是否显示最大化按钮
        area: ['100%', '100%'],  //大小
        content: contextPath + '/manage/manageAnnController/ann_details?id='+id
    });
}

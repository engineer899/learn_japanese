function deleteCourse(course_id){
    layer.confirm('是否删除？', {icon: 3, title:'提示'}, function(index){
        //执行删除
        $.ajax({
            url : contextPath + '/manage/videoController/deleteCourse',
            timeout : 300000,
            dataType : "json",
            type : "post",
            data : {
...
function addCourse(){
    layer.open({
        ...
        area: ['100%', '100%'],  //大小
        content: contextPath + '/manage/videoController/course_add'
    });
}
...
function videoList(id){
    layer.open({
        ...
        maxmin: false,		//是否显示最大化按钮
        area: ['95%', '95%'],  //大小
        content: contextPath + '/manage/videoController/video_list?course_id='+id
    });
}

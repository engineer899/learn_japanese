...
<head>
    ...
    <script src="${ctp}/static/scripts/myjs/c_course.js"></script>
</head>
<script>
    layui.use(['table','form'], function(){
        ...
        table.render({
            elem: '#test'
            ,url:'${ctp}/manage/courseController/queryCourseListPage'
            ,cols: [[
...
<script type="text/html" id="caozuo">
    ...
    <a class='layui-btn layui-btn-normal layui-btn-xs' onclick="courseWareList('{{d.course_id}}')">添加课件</a>
</script>
                ...
                <div class="layui-card-body">
                    <form class="layui-form">
                        <div class="demoTable" style="text-align: right;margin-bottom: 10px;">
                            ...
                            <%--</select>--%>
                            <%--</div>--%>
                            <a class="layui-btn layui-btn-sm layui-btn-normal" onclick="addCourse()" style="float:left;"> <i class="layui-icon layui-icon-add-1"></i>新增书本</a>

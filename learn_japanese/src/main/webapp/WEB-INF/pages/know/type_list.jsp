...
<script>
    ...
    layui.use(['table','form'], function(){
        ...
        table.render({
            elem: '#test'
            ,url:'${ctp}/manage/knowController/queryTypeList'
            ,cols: [[
                {type:'numbers',width:'4%', title: '序号'}
                ,{field:'type_name',width:'10%',  title: '类型名字'}
...
<script type="text/html" id="caozuo">
    ...
    <a class='layui-btn layui-btn-normal layui-btn-xs' onclick="knowList('{{d.type_id}}')">添加小知识</a>
</script>
                    ...
                    <form class="layui-form">
                        <div class="demoTable" style="text-align: right;margin-bottom: 10px;">
                            ...
                            <div class="layui-input-inline">
                                <input  placeholder="请输入类型名称"  name="type_name" id="type_name" class="layui-input">
                            </div>

                            <a class="layui-btn layui-btn-sm layui-btn-normal" onclick="addType()" style="float:left;"> <i class="layui-icon layui-icon-add-1"></i>新增</a>
